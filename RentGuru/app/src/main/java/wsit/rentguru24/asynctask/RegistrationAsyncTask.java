...
import wsit.rentguru24.activity.RegistrationActivity;
 ...
 */
public class RegistrationAsyncTask extends AsyncTask<Boolean, Void, ResponseStat> {
    ...
    public RegistrationAsyncTask(RegistrationActivity context,Registration registration)
    {
    ...
    protected ResponseStat doInBackground(Boolean... params) {
        ...
        try {
            ...
            response  =  authenticationService.registrationRequest(registration);
