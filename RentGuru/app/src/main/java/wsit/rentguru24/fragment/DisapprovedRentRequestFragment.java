 ...
 */
public class DisapprovedRentRequestFragment extends Fragment implements AbsListView.OnScrollListener, AdapterView.OnItemClickListener {
    private View view;
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        if (rentRequestArrayList.size()>0) {
